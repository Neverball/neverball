...
cp /opt/local/lib/libpng12.a /opt/local/lib/libjpeg.a /opt/local/lib/libintl.a /opt/local/lib/libiconv.a /opt/local/lib/libvorbis.a /opt/local/lib/libvorbisenc.a /opt/local/lib/libvorbisfile.a /opt/local/lib/libogg.a external_libs/.
cp /opt/local/include/libpng12/png.h /opt/local/include/libpng12/pngconf.h /opt/local/include/jpeglib.h /opt/local/include/jconfig.h /opt/local/include/jmorecfg.h /opt/local/include/jerror.h /opt/local/include/libintl.h /opt/local/include/iconv.h external_libs/.
mkdir external_libs/vorbis
