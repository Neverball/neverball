...
#define CONFIG_DATA   "Neverball.app/Contents/Resources/data" /* Game data directory */
#define CONFIG_LOCALE "Neverball.app/Contents/Resources/locale" /* Game localisation */
...
- (void) setupWorkingDirectory:(BOOL)shouldChdir
{
    ...
    *c++ = '\0';             /* cut off last part (binary name) */
	...
	/* LF BIG HACK */
	/* the XX.app/Contents/Resources is always the default directory in order to 
	  to have good path to ./locale and ./data 
