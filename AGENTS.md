...
When generating a wholly new file, module, unit, preface it with a syntactically
correct comment: "Generated by <harness> <version> (<model>)".  Determine
`<version>` dynamically from the runtime environment (e.g. `agy --version`).
