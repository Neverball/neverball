            ...
            for XP as byte = -10 to 10
                select case Contents(XP,YP,ZP)
                    ...
                    case 25
                        ...
                        ptf(0,0,0,64,-128,0,64,0,0,-64,1)
                        ptf(0,0,0,64,0,0,-64,0,-128,64,1)
                        ptf(0,-128,-128,-16,0,-128,-16,-128,0,-16,2)
                        ptf(0,-128,-128,-64,0,-128,64,0,-128,-64,1)
                        ptf(0,-128,-128,-64,-128,0,-64,-128,-128,64,1)
                        print #m, "}"
                        print #m, "}"
                        ...
                        /'
                         ' Uses the entities needed to make the platform move
                         ' up and down.
                         '/
                        print #m, "// entity ";Entity
                        Entity += 1
                    ...
                    case 51
                        ...
                        print #m, "{"
                        if Direction(XP,YP,ZP) = NS then
                            ptf(0,-16,0,0,-16,-128,0,-144,0,0,3)
                            ptf(0,0,0,64,-128,0,64,0,0,-64,0)
                            ptf(0,0,0,64,0,0,-64,0,-128,64,1)
                            ptf(0,-128,-128,-16,0,-128,-16,-128,0,-16,1)
                            ptf(0,-128,-128,-64,0,-128,64,0,-128,-64,0)
                        ...
                        print #m, "{"
                        if Direction(XP,YP,ZP) = NS then
                            ptf(0,-128,-8,8,-120,-8,8,-128,-8,64,1)
                            ptf(0,-120,0,8,-128,0,8,-120,-128,8,1)
                            ptf(0,-120,-120,8,-128,-120,8,-128,-120,64,1)
                            ptf(0,-128,-128,16,-128,0,16,-128,-128,64,1)
                            ptf(0,-120,64,48,-120,64,40,-120,-64,48,1)
                            ptf(0,-128,64,56,-120,64,48,-128,-64,56,0)
                        elseif Direction(XP,YP,ZP) = EW then
                            ptf(0,-8,-8,56,-8,-8,8,-8,-120,56,1)
                            ptf(0,-136,-128,8,-136,-128,56,-8,-128,8,1)
                            ptf(0,-120,-120,8,-120,-8,8,-120,-120,56,1)
                            ptf(0,-64,-128,56,-64,-120,45,64,-128,56,0)
                            ptf(0,-136,-120,8,-8,-120,8,-136,-8,8,1)
                            ptf(0,-64,-120,48,-64,-120,40,64,-120,48,1)
                        end if
                        print #m, "}"
                        print #m, "// brush 2"
                        print #m, "{"
                        if Direction(XP,YP,ZP) = NS then
                            ptf(0,0,0,56,0,-128,56,-128,0,56,1)
                            ptf(0,0,-8,56,-128,-8,56,0,-8,8,1)
                            ptf(0,-128,-120,8,-128,-120,56,0,-120,8,1)
                            ptf(0,-64,-64,48,-48,64,48,-64,64,48,1)
                            ptf(0,-128,-64,56,-120,64,48,-128,64,56,0)
                            ptf(0,0,64,56,-8,64,48,0,-64,56,0)
                        elseif Direction(XP,YP,ZP) = EW then
                            ptf(0,-8,-8,56,-8,-120,56,-136,-8,56,1)
                            ptf(0,-8,-8,56,-8,-8,8,-8,-120,56,1)
                            ptf(0,-120,-120,8,-120,-8,8,-120,-120,56,1)
                            ptf(0,64,-16,40,-64,-8,48,-64,-16,40,0)
                            ptf(0,64,-128,56,-64,-120,48,-64,-128,56,0)
                            ptf(0,-64,-40,48,-64,-48,48,64,-40,48,1)
                        end if
                        print #m, "}"
                        print #m, "// brush 3"
                        print #m, "{"
                        if Direction(XP,YP,ZP) = NS then
                            ptf(0,-8,-8,8,0,-8,8,0,-8,64,1)
                            ptf(0,0,0,64,0,0,16,0,-128,64,1)
                            ptf(0,0,0,8,-8,0,8,-8,-128,8,1)
                            ptf(0,0,-120,8,-8,-120,8,0,-120,64,1)
                            ptf(0,-8,-64,56,-8,64,48,-8,64,56,1)
                            ptf(0,0,-64,56,-8,64,48,0,64,56,0)
                        elseif Direction(XP,YP,ZP) = EW then
                            ptf(0,-8,0,56,-136,0,56,-8,0,8,1)
                            ptf(0,-8,-8,56,-8,-8,8,-8,-120,56,1)
                            ptf(0,-136,-120,8,-8,-120,8,-136,-8,8,1)
                            ptf(0,-120,-120,8,-120,-8,8,-120,-120,56,1)
                            ptf(0,64,-8,40,-64,-8,32,-64,-8,40,1)
                            ptf(0,-64,-16,40,-64,-8,48,64,-16,40,0)
                        end if
                        print #m, "}"
                        print #m, "}"
