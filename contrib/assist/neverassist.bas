...
print "Which enviroment do you want?"
print
...
do
	...
	if multikey(SC_RIGHT) then XP += 1 else if multikey(SC_LEFT) then XP -= 1
	if multikey(SC_UP) then YP += 1 else if multikey(SC_DOWN) then YP -= 1
	if multikey(SC_PAGEUP) then ZP += 1 else if multikey(SC_PAGEDOWN) then ZP -= 1
	if (multikey(SC_PLUS) OR multikey(SC_EQUALS)) AND (NOT multikey(SC_LSHIFT)) then
		LevelTime += 25
	elseif multikey(SC_MINUS) AND (NOT multikey(SC_LSHIFT)) then
		if LevelTime < 25 then LevelTime = 0 else LevelTime -= 25
	elseif (multikey(SC_PLUS) OR multikey(SC_EQUALS)) AND multikey(SC_LSHIFT) then
		TargetCoins += 1
	...
	if (NOT multikey(SC_ENTER)) AND (NOT multikey(SC_SLASH)) AND (Hold > 0) then Hold -= 1
	...
	color 14
	locate 4,54
	if MusicSwitch = 0 then print "Music stopped." else print "Music playing..."
	color 13
	locate 5,54
...
if (Warning = 0) then
	...
	if (LevelMessage < > "") then print #1, chr(34)+"message"+chr(34)+" "+chr(34);LevelMessage;chr(34)
	print #1, chr(34)+"time"+chr(34)+" "+chr(34);LevelTime;chr(34)
	print #1, chr(34)+"goal"+chr(34)+" "+chr(34);TargetCoins;chr(34)
	print #1, chr(34)+"back"+chr(34)+" "+chr(34);Back;chr(34)
	print #1, chr(34)+"grad"+chr(34)+" "+chr(34);Grad;chr(34)
	print #1, chr(34)+"song"+chr(34)+" "+chr(34);Song;chr(34)
	print #1, chr(34)+"levelname"+chr(34)+" "+chr(34);LevelName;chr(34)
	print #1, "}"
	close #1
