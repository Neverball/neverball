...
sub place_block
	if multikey(SC_SPACE) AND (BlockType = 1) AND (BlockSet = 0) AND (Start = 0) AND (YP < 10) AND PlacementTest(PlacementFormula) = 0 then
		print #1, "// entity ";Entity;"
		Entity += 1
		print #1, "{"
		print #1, chr(34)+"classname"+chr(34)+" "+chr(34)+"worldspawn"+chr(34)
		print #1, "// brush 0"
		print #1, "{"
		...
		Entity += 1
		print #1, "{"
		print #1, chr(34)+"classname"+chr(34)+" "+chr(34)+"info_player_start"+chr(34)
		print #1, chr(34)+"origin"+chr(34)+" "+chr(34)& XP*128-64;" "& YP*128-64;" "& ZP*64+24;chr(34)
		print #1, "}"
		print #1, "// entity ";Entity;"
		Entity += 1
		print #1, "{"
		print #1, chr(34)+"classname"+chr(34)+" "+chr(34)+"info_player_intermission"+chr(34)
		print #1, chr(34)+"origin"+chr(34)+" "+chr(34)& XP*128-64;" "& YP*128-64;" "& ZP*64+224;chr(34)
		print #1, chr(34)+"target"+chr(34)+" "+chr(34)+"goal"+chr(34)
		print #1, "}"
		Start = 1
		...
		Openings += 1
		Putt = 2
	elseif multikey(SC_SPACE) AND (BlockType = 2) AND (BlockSet = 0) AND (Money + 1 < = MaxMoney) AND PlacementTest(PlacementFormula) = 0 then
		print #1, "// entity ";Entity;"
		Entity += 1
		print #1, "{"
		print #1, chr(34)+"classname"+chr(34)+" "+chr(34)+"worldspawn"+chr(34)
		...
		Blocks += 1
		Putt = 2
	elseif multikey(SC_SPACE) AND (BlockType = 3) AND (BlockSet = 0) AND (Money + 1 < = MaxMoney) AND PlacementTest(PlacementFormula) = 0 then
		print #1, "// entity ";Entity;"
		Entity += 1
		print #1, "{"
		print #1, chr(34)+"classname"+chr(34)+" "+chr(34)+"worldspawn"+chr(34)
		...
		Blocks += 1
		Putt = 2
	elseif multikey(SC_SPACE) AND (BlockType = 4) AND (BlockSet = 0) AND (Money + 1 < = MaxMoney) AND PlacementTest(PlacementFormula) = 0 then
		print #1, "// entity ";Entity;"
		Entity += 1
		print #1, "{"
		print #1, chr(34)+"classname"+chr(34)+" "+chr(34)+"worldspawn"+chr(34)
		...
		Openings += 1
		Putt = 2
	elseif multikey(SC_SPACE) AND (BlockType = 5) AND (BlockSet = 0) AND (Money + 1 < = MaxMoney) AND PlacementTest(PlacementFormula) = 0 then
		print #1, "// entity ";Entity;"
		Entity += 1
		print #1, "{"
		print #1, chr(34)+"classname"+chr(34)+" "+chr(34)+"worldspawn"+chr(34)
		...
		Openings += 2
		Putt = 2
	elseif multikey(SC_SPACE) AND (BlockType = 6) AND (BlockSet = 0) AND (Money + 1 < = MaxMoney) AND PlacementTest(PlacementFormula) = 0 then
		print #1, "// entity ";Entity;"
		Entity += 1
		print #1, "{"
		print #1, chr(34)+"classname"+chr(34)+" "+chr(34)+"worldspawn"+chr(34)
		...
		Entity += 1
		print #1, "{"
		print #1, chr(34)+"classname"+chr(34)+" "+chr(34)+"light"+chr(34)
		print #1, chr(34)+"origin"+chr(34)+" "+chr(34)& XP*128-96;" "& YP*128-96;" "& ZP*64+24;chr(34)
		print #1, chr(34)+"light"+chr(34)+" "+chr(34)+"1"+chr(34)
		print #1, "}"
		print #1, "// entity ";Entity;"
		Entity += 1
		print #1, "{"
		print #1, chr(34)+"classname"+chr(34)+" "+chr(34)+"light"+chr(34)
		print #1, chr(34)+"origin"+chr(34)+" "+chr(34)& XP*128-32;" "& YP*128-96;" "& ZP*64+24;chr(34)
		print #1, chr(34)+"light"+chr(34)+" "+chr(34)+"1"+chr(34)
		print #1, "}"
		print #1, "// entity ";Entity;"
		Entity += 1
		print #1, "{"
		print #1, chr(34)+"classname"+chr(34)+" "+chr(34)+"light"+chr(34)
		print #1, chr(34)+"origin"+chr(34)+" "+chr(34)& XP*128-96;" "& YP*128-32;" "& ZP*64+24;chr(34)
		print #1, chr(34)+"light"+chr(34)+" "+chr(34)+"1"+chr(34)
		print #1, "}"
		print #1, "// entity ";Entity;"
		Entity += 1
		print #1, "{"
		print #1, chr(34)+"classname"+chr(34)+" "+chr(34)+"light"+chr(34)
		print #1, chr(34)+"origin"+chr(34)+" "+chr(34)& XP*128-32;" "& YP*128-32;" "& ZP*64+24;chr(34)
		print #1, chr(34)+"light"+chr(34)+" "+chr(34)+"1"+chr(34)
		print #1, "}"
		...
		Blocks += 1
		Putt = 2
	elseif multikey(SC_SPACE) AND (BlockType = 7) AND (BlockSet = 0) AND (Money + 1 < = MaxMoney) AND PlacementTest(PlacementFormula) = 0 then
		print #1, "// entity ";Entity;"
		Entity += 1
		print #1, "{"
		print #1, chr(34)+"classname"+chr(34)+" "+chr(34)+"worldspawn"+chr(34)
		...
		Blocks += 1
		Putt = 2
	elseif multikey(SC_SPACE) AND (BlockType = 8) AND (BlockSet = 0) AND (Money + 1 < = MaxMoney) AND PlacementTest(PlacementFormula) = 0 then
		print #1, "// entity ";Entity;"
		Entity += 1
		print #1, "{"
		print #1, chr(34)+"classname"+chr(34)+" "+chr(34)+"worldspawn"+chr(34)
		...
		Openings -= 1
		Putt = 2
	elseif multikey(SC_SPACE) AND (BlockType = 9) AND (BlockSet = 0) AND (Money + 1 < = MaxMoney) AND PlacementTest(PlacementFormula) = 0 then
		print #1, "// entity ";Entity;"
		Entity += 1
		print #1, "{"
		print #1, chr(34)+"classname"+chr(34)+" "+chr(34)+"worldspawn"+chr(34)
		...
		Openings -= 1
		Putt = 2
	elseif multikey(SC_SPACE) AND (BlockType = 10) AND (BlockSet = 0) AND (Money + 2 < = MaxMoney) AND PlacementTest(PlacementFormula) = 0 then
		print #1, "// entity ";Entity;"
		Entity += 1
		print #1, "{"
		print #1, chr(34)+"classname"+chr(34)+" "+chr(34)+"worldspawn"+chr(34)
		...
		Blocks += 1
		Putt = 2
	elseif multikey(SC_SPACE) AND (BlockType = 11) AND (BlockSet = 0) AND (Money + 1 < = MaxMoney) AND PlacementTest(PlacementFormula) = 0 then
		print #1, "// entity ";Entity;"
		Entity += 1
		print #1, "{"
		print #1, chr(34)+"classname"+chr(34)+" "+chr(34)+"worldspawn"+chr(34)
		...
		Openings += 1
		Putt = 2
	elseif multikey(SC_SPACE) AND (BlockType = 12) AND (BlockSet = 0) AND (Money + 1 < = MaxMoney) AND PlacementTest(PlacementFormula) = 0 then
		print #1, "// entity ";Entity;"
		Entity += 1
		print #1, "{"
		print #1, chr(34)+"classname"+chr(34)+" "+chr(34)+"worldspawn"+chr(34)
		...
		Openings += 2
		Putt = 2
	elseif multikey(SC_SPACE) AND (BlockType = 13) AND (BlockSet = 0) AND (Money + 1 < = MaxMoney) AND PlacementTest(PlacementFormula) = 0 AND PlacementTest(PlacementFormula+2000) = 0 then
		print #1, "// entity ";Entity;"
		Entity += 1
		print #1, "{"
		print #1, chr(34)+"classname"+chr(34)+" "+chr(34)+"worldspawn"+chr(34)
		...
		Blocks += 1
		Putt = 2
	elseif multikey(SC_SPACE) AND (BlockType = 14) AND (BlockSet = 0) AND (Money + 1 < = MaxMoney) AND PlacementTest(PlacementFormula) = 0 then
		print #1, "// entity ";Entity;"
		Entity += 1
		print #1, "{"
		print #1, chr(34)+"classname"+chr(34)+" "+chr(34)+"worldspawn"+chr(34)
		...
		Blocks += 1
		Putt = 2
	elseif multikey(SC_SPACE) AND (BlockType = 15) AND (BlockSet = 0) AND (Money + 1 < = MaxMoney) AND PlacementTest(PlacementFormula) = 0 then
		print #1, "// entity ";Entity;"
		Entity += 1
		print #1, "{"
		print #1, chr(34)+"classname"+chr(34)+" "+chr(34)+"worldspawn"+chr(34)
		...
		print #1, "{"
		print #1, chr(34)+"classname"+chr(34)+" "+chr(34)+"light"+chr(34)
		print #1, chr(34)+"origin"+chr(34)+" "+chr(34)& XP*128-96;" "& YP*128-96;" "& ZP*64+32;chr(34)
		print #1, chr(34)+"light"+chr(34)+" "+chr(34)+"1"+chr(34)
		print #1, "}"
		print #1, "// entity ";Entity;"
		Entity += 1
		print #1, "{"
		print #1, chr(34)+"classname"+chr(34)+" "+chr(34)+"light"+chr(34)
		print #1, chr(34)+"origin"+chr(34)+" "+chr(34)& XP*128-32;" "& YP*128-96;" "& ZP*64+32;chr(34)
		print #1, chr(34)+"light"+chr(34)+" "+chr(34)+"1"+chr(34)
		print #1, "}"
		print #1, "// entity ";Entity;"
		Entity += 1
		print #1, "{"
		print #1, chr(34)+"classname"+chr(34)+" "+chr(34)+"light"+chr(34)
		print #1, chr(34)+"origin"+chr(34)+" "+chr(34)& XP*128-96;" "& YP*128-32;" "& ZP*64+32;chr(34)
		print #1, chr(34)+"light"+chr(34)+" "+chr(34)+"1"+chr(34)
		print #1, "}"
		print #1, "// entity ";Entity;"
		Entity += 1
		print #1, "{"
		print #1, chr(34)+"classname"+chr(34)+" "+chr(34)+"light"+chr(34)
		print #1, chr(34)+"origin"+chr(34)+" "+chr(34)& XP*128-32;" "& YP*128-32;" "& ZP*64+32;chr(34)
		print #1, chr(34)+"light"+chr(34)+" "+chr(34)+"1"+chr(34)
		print #1, "}"
		PlacementTest(PlacementFormula) = 15
		place_gfx(0)
		...
		Blocks += 1
		Putt = 2
	elseif multikey(SC_SPACE) AND (BlockType = 16) AND (BlockSet = 0) AND (Money + 3 < = MaxMoney) AND PlacementTest(PlacementFormula) = 0 then
		print #1, "// entity ";Entity;"
		Entity += 1
		print #1, "{"
		print #1, chr(34)+"classname"+chr(34)+" "+chr(34)+"worldspawn"+chr(34)
		...
		Entity += 1
		print #1, "{"
		print #1, chr(34)+"classname"+chr(34)+" "+chr(34)+"func_train"+chr(34)
		print #1, "// brush 0"
		print #1, "{"
		if (Rotation = 1) OR (Rotation = 3) then
		...
		Entity += 1
		print #1, "{"
		print #1, chr(34)+"classname"+chr(34)+" "+chr(34)+"path_corner"+chr(34)
		if (Rotation = 1) OR (Rotation = 3) then
			print #1, chr(34)+"origin"+chr(34)+" "+chr(34)& XP*128-32;" "& YP*128-64;" "& ZP*64-16;chr(34)
		elseif (Rotation = 2) OR (Rotation = 4) then
			print #1, chr(34)+"origin"+chr(34)+" "+chr(34)& XP*128-64;" "& YP*128-96;" "& ZP*64-16;chr(34)
		end if
		print #1, chr(34)+"targetname"+chr(34)+" "+chr(34)+"path_corner";Entity-1;chr(34)
		print #1, chr(34)+"target"+chr(34)+" "+chr(34)+"path_corner";Entity;chr(34)
		print #1, chr(34)+"speed"+chr(34)+" "+chr(34)+"3"+chr(34)
		print #1, "}"
		print #1, "// entity ";Entity;"
		Entity += 1
		print #1, "{"
		print #1, chr(34)+"classname"+chr(34)+" "+chr(34)+"path_corner"+chr(34)
		if (Rotation = 1) OR (Rotation = 3) then
			print #1, chr(34)+"origin"+chr(34)+" "+chr(34)& XP*128-96;" "& YP*128-64;" "& ZP*64-16;chr(34)
		elseif (Rotation = 2) OR (Rotation = 4) then
			print #1, chr(34)+"origin"+chr(34)+" "+chr(34)& XP*128-64;" "& YP*128-32;" "& ZP*64-16;chr(34)
		end if
		print #1, chr(34)+"targetname"+chr(34)+" "+chr(34)+"path_corner";Entity-1;chr(34)
		print #1, chr(34)+"target"+chr(34)+" "+chr(34)+"path_corner";Entity-2;chr(34)
		print #1, chr(34)+"speed"+chr(34)+" "+chr(34)+"3"+chr(34)
		print #1, "}"
		PlacementTest(PlacementFormula) = 2
		place_gfx(0)
		...
		Blocks += 2
		Putt = 2
	elseif multikey(SC_SPACE) AND (BlockType = 26) AND (BlockSet = 0) AND PlacementTest(PlacementFormula) = 0 then
		print #1, "// entity ";Entity;"
		Entity += 1
		print #1, "{"
		print #1, chr(34)+"classname"+chr(34)+" "+chr(34)+"worldspawn"+chr(34)
		...
		Entity += 1
		print #1, "{"
		print #1, chr(34)+"classname"+chr(34)+" "+chr(34)+"info_player_deathmatch"+chr(34)
		print #1, chr(34)+"origin"+chr(34)+" "+chr(34)& XP*128-64;" "& YP*128-64;" "& ZP*64+24;chr(34)
		print #1, "}"
		if Finish = 0 then
			print #1, "// entity ";Entity;"
			Entity += 1
			print #1, "{"
			print #1, chr(34)+"classname"+chr(34)+" "+chr(34)+"target_position"+chr(34)
			print #1, chr(34)+"origin"+chr(34)+" "+chr(34)& XP*128-64;" "& YP*128-64;" "& ZP*64+128;chr(34)
			print #1, chr(34)+"targetname"+chr(34)+" "+chr(34)+"goal"+chr(34)
			print #1, "}"
		end if
