...
enum {
    ...
    CONFIG_REPLAY_NAME,
    CONFIG_CAMERA_SPEED,
    CONFIG_CAMERA_DISTANCE,
    CONFIG_CAMERA_DISTANCE_NEAR,
    CONFIG_CAMERA_ACCELERATION,
    CONFIG_CAMERA_ACCELERATION_NEAR,
...
#define DEFAULT_CAMERA_DISTANCE_NEAR "13.f"
#define DEFAULT_CAMERA_ACCELERATION  "0.0005f"
#define DEFAULT_CAMERA_ACCELERATION_NEAR "0.0005f"

#define CAMERA_SPEED_SLOW            DEFAULT_CAMERA_SPEED
#define CAMERA_DISTANCE_SLOW         DEFAULT_CAMERA_DISTANCE
#define CAMERA_DISTANCE_NEAR_SLOW    DEFAULT_CAMERA_DISTANCE_NEAR
#define CAMERA_ACCELERATION_SLOW     DEFAULT_CAMERA_ACCELERATION
#define CAMERA_ACCELERATION_NEAR_SLOW DEFAULT_CAMERA_ACCELERATION_NEAR
#define CAMERA_SPEED_FAST            "9.25f"
#define CAMERA_DISTANCE_FAST         "0.1"
#define CAMERA_DISTANCE_NEAR_FAST    "6.5"
#define CAMERA_ACCELERATION_FAST     "0.003"
#define CAMERA_ACCELERATION_NEAR_FAST "0.001"
