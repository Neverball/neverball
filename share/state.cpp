...
static struct stick_cache stick_cache_l[STICK_MAX];
...
static void cache_stick(int a, float v, float t)
{
    ...
    {
        struct stick_cache *sc = &stick_cache_l[i];
    ...
    {
        struct stick_cache *sc = &stick_cache_l[stick_count];
...
int goto_state(struct state *st)
{
    ...
    memset(&stick_cache_l, 0, sizeof (stick_cache));
    stick_count = 0;
