...
static struct
{
    ...
    { &CONFIG_JOYSTICK_DPAD_L,        "joystick_dpad_l",        9 },
    { &CONFIG_JOYSTICK_DPAD_R,        "joystick_dpad_r",        10 },
    { &CONFIG_JOYSTICK_DPAD_U,        "joystick_dpad_u",        11 },
    { &CONFIG_JOYSTICK_DPAD_D,        "joystick_dpad_d",        12 },
